...
! function(a) {
    ...
    var d = function(a, c, d, e) {
            ...
            void 0 != g.data("currotate") && (i = g.data("currotate")), void 0 != g.data("curscale") && "box" == e ? h = 100 * g.data("curscale") : void 0 != g.data("curscale") && (h = g.data("curscale")), b.slotSize(g, c);
            var j = g.attr("src"),
