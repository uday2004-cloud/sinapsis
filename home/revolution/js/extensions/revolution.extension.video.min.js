        ...
        resetVideo: function(a, d) {
            ...
            switch (f.videotype) {
                case "youtube":
                    ...
                    try {
                        if ("on" == f.forcerewind) {
                            ...
                            h = h == -1 ? 0 : h, void 0 != f.player && (0 !== h && !i || j) && (f.player.seekTo(h), f.player.pauseVideo())
                        }
                    } catch (a) {}
                ...
                case "vimeo":
                    ...
                    try {
                        if ("on" == f.forcerewind) {
                            var h = e(f.videostartat),
                                i = h == -1,
                                j = 1 === f.bgvideo || a.find(".tp-videoposter").length > 0;
                            h = h == -1 ? 0 : h, (0 !== h && !i || j) && (k.api("seekTo", h), k.api("pause"))
                        }
                    } catch (a) {}
                    0 == a.find(".tp-videoposter").length && 1 !== f.bgvideo && punchgs.TweenLite.to(a.find("iframe"), .3, {
                        autoAlpha: 1,
                    ...
                    break;
                case "html5":
                    if (c && 1 == f.disablevideoonmobile) return !1;
                    ...
                    if (punchgs.TweenLite.to(n, .3, {
                            ...
                            display: "block",
                            ease: punchgs.Power3.easeInOut
                        }), "on" == f.forcerewind && !a.hasClass("videoisplaying")) try {
                        var h = e(f.videostartat);
                        o.currentTime = h == -1 ? 0 : h
                    } catch (a) {}("mute" == f.volume || b.lastToggleState(a.videomutetoggledby) || d.globalmute === !0) && (o.muted = !0)
            }
        },
        ...
        manageVideoLayer: function(a, g, i, j) {
            ...
            switch (w = l.nextslideatend === !0 ? "" : w, l.videotype = x, z) {
                ...
                case "youtube":
                    ...
                    break;
                case "vimeo":
                    v = "https", a.data("videomarkup", '<iframe style="visible:hidden" src="' + v + "://player.vimeo.com/video/" + o + "?autoplay=0&" + m + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="100%;height:100%"></iframe>')
            }
